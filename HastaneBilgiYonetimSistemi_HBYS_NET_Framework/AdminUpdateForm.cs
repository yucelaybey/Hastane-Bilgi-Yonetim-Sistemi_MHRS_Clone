...
{
    public partial class AdminUpdateForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public AdminUpdateForm(string _tcno, int _id, string _name,string _surname, string _gender,string _date,string _mail,string _phonenumber,string _username)
        {
            tcno = _tcno;
            id = _id;
            name = _name;
        ...
        {
            txtAdminTcNo.Text = tcno;
            txtAdminName.Text = name;
            txtAdminSurname.Text = surname;
            txtAdminUsername.Text = username;
            DropdownAdminGender.SelectedItem = gender.ToString();
            DatePickerAdminBorn.Text = date;
            txtAdminMail.Text = mail;
            txtAdminPhoneNumber.Text = phonenumber;
        }
        ...
        public async Task AdminSave(string tc, string ad, string soyad, string mail, string telefon, string cinsiyet, DateTime dogumTarihi, string username)
        {
            ...
            string query = @"UPDATE Admins SET TcNo = @TcNo, Name = @Name, Surname = @Surname, Gender = @Gender, [Date] = @Date, Email = @Email, PhoneNumber = @PhoneNumber, Username =@Username WHERE Id = @Id;";
        ...
        private void AdminUpdateForm_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                btn_AdminUpdate_Click(sender, e);
