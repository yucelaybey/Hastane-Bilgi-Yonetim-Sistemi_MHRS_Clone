...
{
    public partial class AdminInformationPasswordChangeForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public AdminInformationPasswordChangeForm(int _id, string _oldPassword)
        {
            InitializeComponent();
        ...
        private void AdminInformationPasswordChangeForm_Load(object sender, EventArgs e)
        {
            PasswordProperty();
            OldPasswordProperty();
        ...
        private void DarkModeOpen()
        {
            if (isDarkMode)
            {
                ...
                panelInAdminPasswordUpdate.BackgroundColor = Color.FromArgb(64, 64, 64);

                labelPreviousPassword.ForeColor = Color.FromArgb(249, 249, 249);
                labelPreviousPassword.BackColor = Color.FromArgb(64, 64, 64);

                labelNewPasssword.ForeColor = Color.FromArgb(249, 249, 249);
                labelNewPasssword.BackColor = Color.FromArgb(64, 64, 64);

                labelNewRepeatPassword.ForeColor = Color.FromArgb(249, 249, 249);
                labelNewRepeatPassword.BackColor = Color.FromArgb(64, 64, 64);
            ...
            else
            {
                ...
                panelInAdminPasswordUpdate.BackgroundColor = Color.FromArgb(230, 230, 230);

                labelPreviousPassword.ForeColor = Color.FromArgb(26, 26, 26);
                labelPreviousPassword.BackColor = Color.FromArgb(230, 230, 230);

                labelNewPasssword.ForeColor = Color.FromArgb(26, 26, 26);
                labelNewPasssword.BackColor = Color.FromArgb(230, 230, 230);

                labelNewRepeatPassword.ForeColor = Color.FromArgb(26, 26, 26);
                labelNewRepeatPassword.BackColor = Color.FromArgb(230, 230, 230);
        ...
        private void AdminInformationPasswordChangeForm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private async void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            if (!(oldPassword == "") && !(password == "") && !(passwordConfirm == "") && !(oldPassword == null) && !(password == null) && !(passwordConfirm == null) &&
        ...
        {
            string query = @"UPDATE Admins SET Password = @NewPassword, PasswordConfirm = @NewPasswordConfirm WHERE Id = @Id AND Password = @OldPassword";
        ...
        private void AdminInformationPasswordChangeForm_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            panelAdminPassResetRules.Visible = true;
        }
        ...
        private void TxtPassword_Leave(object sender, EventArgs e)
        {
            ...
            {
                panelAdminPassResetRules.Visible = false;
                PasswordProperty();
            }
